//Define an interface IPerson with properties for Name and Age.Define a class Citizen which 
//implements IPerson and has a constructor which takes a string name and an int age.
